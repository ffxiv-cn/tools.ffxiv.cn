...
function exploreexplain(obj, i) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            insert += '<img onclick="bigger(this)" style="float:right;width:112px;height:63px;" src=image/explore/' + csvList[i][16] + '.jpeg onload="image(this)">';
            insert += '<img onclick="bigger(this)" style="margin-right: 10px;float:right;width:112px;height:63px;right:10px;" src=image/explore/' + csvList[i][15] + '.jpeg onload="image(this)"></p>';
