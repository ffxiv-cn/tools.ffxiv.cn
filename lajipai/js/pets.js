    ...
    var Page = {
        ...
        setTotalPageNums: function () {
            ...
            $('#pagenum').append(
                ...
                '<li style="position: relative;float: right;height: 20px;padding-right: 10px;"><a style="height: 20px;top: -5px;" onclick="localStorageDownload()"><img style="width: 20px;" src="image/导出.png"></a><span style="position: relative;display: inline-block;overflow: hidden;"><span><img style="height: 20px;" src="image/导入.png"></span><input type="file" id="file" accept=".txt" style="position: absolute;right: 0px;top: 0px;" onchange="localStorageInput(pets)" "></input></span></li>'
            );
            Page.setClickPageNum();
        },
