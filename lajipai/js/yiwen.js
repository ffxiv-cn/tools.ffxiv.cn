function yiwen() {
    ...
    $(function () {
        ...
        $('#page').append(
            ...
            , '<ul id="page_check" style="height:101px;"><div id="pagenum" class="pagenum" style="width: 900px;display: flex;"></div></ul>'
            , '<ul id="page_explain" style=""></ul>'
        ...
        $('#page_itemtop').append(
            ...
            , '<li style="width: 190px;"><a><img src="image/000091.tex.png"><div></div></a><p>多变迷宫路线</p></li>'
        );
        $.ajax({
    ...
    var Page = {
        ...
        setTotalPageNums: function () {
            ...
            insert += '<a style="float:left;width:188px;height: 60px;background-image: url(image/yiwen/3.png);margin-right: 20px;margin-left: 20px;background-repeat: round;" class="off" onclick="yiweninfo(this,3)"><p style="top: 60px;position: relative;">多变迷宫 阿罗阿罗岛</p><div class="bd"></div></a>';
            insert += '<a style="float:left;width:188px;height: 60px;background-image: url(image/yiwen/2.png);margin-right: 20px;margin-left: 20px;background-repeat: round;" class="off" onclick="yiweninfo(this,2)"><p style="top: 60px;position: relative;">多变迷宫 六根山</p><div class="bd"></div></a>';
            insert += '<a style="float:left;width:188px;height: 60px;background-image: url(image/yiwen/1.png);margin-right: 20px;margin-left: 20px;background-repeat: round;" class="off" onclick="yiweninfo(this,1)"><p style="top: 60px;position: relative;">多变迷宫 希拉狄哈水道</p><div class="bd"></div></a>';            $("#pagenum").append(insert);
