...
function load() {
    $('#item').append(
        ...
        , '<li style="margin-right: 200px;"><a onclick="newdig()"><img style="animation-delay:1.1s;" src="image/Routing.png"><div><p class="buff" style="color: orange;">Update</p></div></a><p>宝图路线规划</p></li>'
