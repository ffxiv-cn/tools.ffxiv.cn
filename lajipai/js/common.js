...
function load() {
    $('#item').append(
        ...
        , '<li style="margin-right: 200px;"><a onclick="newdig()"><img style="animation-delay:1.1s;" src="image/Routing.png"><div><p class="buff" style="color: orange;"></p></div></a><p>宝图路线规划</p></li>'
        ...
        , '<li><a onclick="manzushop()"><img style="animation-delay:1.3s;" src="image/蛮族兑换.png"><div></div></a><p>蛮族兑换</p></li>'
