...
function load() {
    $('#item').append(
        ...
        // 保险备注
        // , '<li style="margin-right: 200px;"><a onclick=""><img style="animation-delay:1.1s;filter: grayscale(100%)" src="image/000033.tex.png"><div><p class="buff" style="color: white;">New!!</p></div></a><p>有待开发</p></li>'
        ...
        , '<li><a onclick="yiwen()"><img style="animation-delay:1.0s;" src="image/000091.tex.png"><div><p class="buff" style="color: white;">New!!</p></div></a><p>多变迷宫路线</p></li>'
        , '<li><a onclick="dye()"><img style="animation-delay:1.1s;" src="image/染料一览.png"><div></div></a><p>染料一览</p></li>'
        //   蛮族兑换、蛮族兑换.png
