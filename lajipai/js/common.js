...
function load() {
    $('#item').append(        
        '<li style="margin-right: 500px;"><a onclick="check()"><img src="image/更新速览.png"><div></div></a><p>更新速览</p></li>'
        ...
        , '<li style="margin-right: 400px;"><a onclick="explore()"><img style="animation-delay:0.7s;" src="image/探索笔记.png"><div></div></a><p>探索笔记</p></li>'
        ...
        , '<li><a onclick="dig()"><img style="animation-delay:1.0s;" src="image/藏宝图.png"><div></div></a><p>藏宝图</p></li>'
        , '<li style="margin-right: 200px;"><a onclick="newdig()"><img style="animation-delay:1.1s;" src="image/藏宝图.png"><div></div></a><p>新藏宝图</p></li>'
        ...
        , '<li><a onclick="fateshop()"><img style="animation-delay:1.0s;" src="image/危命商人.png"><div></div></a><p>危命商人</p></li>'
        , '<li><a onclick="hunt()"><img style="animation-delay:1.1s;" src="image/狩猎.png"><div></div></a><p>狩猎</p></li>'
        , '<li><a onclick="jobtask()"><img style="animation-delay:1.2s;" src="image/职业任务.png"><div></div></a><p>职业任务</p></li>'
      ...
      //   , '<li><a onclick="bluemagic()"><img style="animation-delay:0.9s;" src="image/青魔.png"><div></div></a><p>青魔法书</p></li>'
        ...
        , '<li><a><img style="animation-delay:1.1s;filter: grayscale(100%)" src="image/蛮族兑换.png"><div></div></a><p>蛮族兑换</p></li>'
        , '<li><a><img style="animation-delay:1.2s;filter: grayscale(100%)" src="image/蛮族兑换.png"><div></div></a><p>有待开发</p></li>'
        , '<li><a><img style="animation-delay:1.3s;filter: grayscale(100%)" src="image/蛮族兑换.png"><div></div></a><p>有待开发</p></li>'
        , '<li><a><img style="animation-delay:1.4s;filter: grayscale(100%)" src="image/蛮族兑换.png"><div></div></a><p>有待开发</p></li>'
        , '<li style="margin-right: 0px;"><a><img style="animation-delay:1.5s;filter: grayscale(100%)" src="image/蛮族兑换.png"><div></div></a><p>有待开发</p></li>'
