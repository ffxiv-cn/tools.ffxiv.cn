...
function load() {
    $('#item').append(
        ...
        , '<li style="margin-right: 200px;"><a onclick="newdig()"><img style="animation-delay:1.1s;filter: grayscale(100%)" src="image/000033.tex.png"><div><p class="buff" style="color: white;">New!!</p></div></a><p>宝图路线规划</p></li>'
