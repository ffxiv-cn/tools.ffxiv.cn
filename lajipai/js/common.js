...
function load() {
    $('#item').append(
        ...
        , '<li><a onclick="pets()"><img style="animation-delay:0.6s;" src="image/宠物.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>宠物一览</p></li>'
        , '<li style="margin-right: 400px;"><a onclick="mounts()"><img style="animation-delay:0.7s;" src="image/坐骑.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>坐骑一览</p></li>'
        , '<li><a onclick="music()"><img style="animation-delay:0.7s;" src="image/乐谱.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>乐谱</p></li>'
        ...
        , '<li><a onclick="fateshop()"><img style="animation-delay:0.9s;" src="image/危命商人.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>危命商人</p></li>'
        , '<li><a onclick="dungeons()"><img style="animation-delay:1.0s;" src="image/副本开启.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>副本开启</p></li>'
      ...
      //   , '<li><a onclick="bluemagic()"><img style="animation-delay:0.9s;" src="image/青魔.png"><div></div></a><p>青魔法书</p></li>'
        ...
        , '<li><a onclick="dig()"><img style="animation-delay:0.9s;" src="image/藏宝图.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>藏宝图</p></li>'
        , '<li><a onclick="hunt()"><img style="animation-delay:1.0s;" src="image/狩猎.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>狩猎</p></li>'
        , '<li><a onclick="explore()"><img style="animation-delay:1.1s;" src="image/探索笔记.png"><div><p class="buff" style="color: orange;">剧透</p></div></a><p>探索笔记</p></li>'
