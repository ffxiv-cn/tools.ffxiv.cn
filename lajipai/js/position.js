...
$(window).resize(function () {
    ...
    //当浏览器页面发生改变时，DIV随着页面的改变居中。
    if ($("#page_itemtop").children("li:last-child").children("p").text() == "更新速览" || $("#page_itemtop").children("li:last-child").children("p").text() == "多变迷宫路线") {
...
function back() {
    ...
    $('#main').append(
        ...
        , '<div id="right" style="opacity: 0;height: auto;"><ul id="notice_title"></ul><ul id="notice" style="height:239px;"></ul><ul id="update_title"></ul><ul id="update_log"></ul></div>'
    );
    testgg();
    if (document.documentElement.clientWidth - 1004 > 40) {
        $("#right").css("width", 327);
